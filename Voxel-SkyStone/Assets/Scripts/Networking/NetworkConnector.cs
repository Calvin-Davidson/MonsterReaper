...
namespace Networking
{
    public class NetworkConnector : MonoBehaviour
    {
         ...
         {
             networkData.Client = networkData.Localhost ? new WebSocket("ws://localhost:80") : new WebSocket("ws://voxel-relay.herokuapp.com/");
             ...
             if (networkData.Client.IsAlive) onConnectionSuccessful?.Invoke();
